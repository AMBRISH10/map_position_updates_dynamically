...
class GPSVis(object):
    ...
    def plot_map(self, output='save', save_as='resultMap.png'):
        ...
        axis1.set_xticks(np.arange(len(self.x_ticks)))
        axis1.set_yticks(np.arange(len(self.y_ticks)))
    ...
    def get_ticks(self):
        ...
        self.y_ticks = list(map(lambda x: round(x, 4), np.linspace(self.points[2], self.points[0], num=8)))
        self.y_ticks.reverse()
